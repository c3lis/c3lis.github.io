...
function init(){
	function listener(){
		...
		mkdir /home/anonimo/.www/wwwTryHackMe/imgs/$1 2>/dev/null &>/dev/null && echo -e "\e[33;1mCarpeta Name \e[0m\e[35;1m $1\e[0m";
	}
	...
	function sendel(){
		...
		for x in $(seq 1 10000);do
			x=$x
			if test -f /home/anonimo/Captura\ de\ pantalla\ de\ 2023-05-*; then
				mv /home/anonimo/Captura\ de\ pantalla\ de\ 2023-05-* /home/anonimo/.www/wwwTryHackMe/imgs/$1/$1$parameterCounter.jpg
