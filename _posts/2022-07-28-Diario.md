...
<p><font color="yellow">[<font color="red">*</font>]</font> Creacion de tareas para ejecutarce en un determinado tiempo</p>
<p>Para ver las tareas que se estan ejecutando a tiempo real se usa el comando : </p>
```1
ps -eo command
```
