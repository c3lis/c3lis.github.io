...
<p>Hola aqui estara un blog  personal, donde les mostrare lo que aprendo cada dia, y algunas cosas que ya tengo en cuenta pero que les quiero compartir.</p>
...
<br>
<p><center><font color="yellow">[<font color="red">*</font>]</font> <font color="green"> Creacion de usuarios y permisos.</font></center></p>
<br>
<p>Creacion de usuarios en el sistema: </p>
...
<p><font color="blue">--></font> w <font color="yellow">-></font>  Puede escrbir el fichero [ read ].</p>

<p><font color="yellow">--></font> x <font color="yellow">-></font>  pude ejuctar el archivo [ executable ] o <b> Directorio</b> le permite entonces entrar al directorio.</p>
...
<br>
<b>Es</b> decir si este permiso estubiera activo ahora `rwx-rwx-rwx` en un archivo, todos tendrian permiso de lectura, escritura, ejecucion.
<br>
<br>
<font color="lime"><font color="yellow">[<font color="red">*</font>]</font> 2022-07-29</font>
<p><center><font color="yellow">[<font color="red">*</font>]</font><font color="green"> Creacion de grupos</font></center></p> 
<br>
...
* -V <font color="yellow">-></font>  Verbose, es decir muestrame por pantalla los cambios efectuados.
...
-----
<br>
<p><center><font color="yellow">[<font color="red">*</font>]</font><font color="green"> Explotacion y vulnerabilidad de permisos </font></center></p>
<br>
<p><font color="yellow"></font> Explotacion por <font color="blue">SUID</font>: </p>
...
Para crakerla debemos copiar el hash deseado y meterlo a un txt en este caso mis hash estara en el archivo `hash`
...
cambiamos la `x` en `/etc/passwd` para que no leea el archivo `/etc/shadow/` sino que mas bien leea lo que  le  pasemos directamente
que va a ser un <font color="blue">hash</font> el cual lo vamos a generar con el comando `openssl` para burlarnos la seguridad y asi
poderle cambiar la contraseña <font color="red">Root</font>.
...
<b><font color="yellow">*</font></b> Como puden ver ya genere con `openssl` el `sha` y lo puse al lado del usuario <font color="red">Root</font> en el archivo `/etc/passwd/` ahora si hago
...
<br>
<p><center><font color="yellow">[<font color="red">*</font>]</font><font color="green"> Creacion de tareas para ejecutarce en un determinado tiempo </font></center></p>
<br>
...
<p><font color="yellow">*</font> Luego esta la palabra <font color="red">Root</font> significa que el usario <font color="red">Root</font> ejecutara esta tarea durante cada minuto. </p>
...
<p><b><font color="yellow">*</font></b> Ya luego lo que este en esa ruta el <font color="blue"> Cron</font> lo ejecutara segun el tiempo que le hayas colacado.</p>
<b><font color="yellow">*</font></b> Dentro del archivo `ejecutame.sh` que esta en la ruta `/home/s4ntiago/mesa/ejecutame.sh` que fue la ruta que colocamos dentro del
archivo `tarea` para que nos lo ejecutara, estara un script que me prendera las luces del <font color="red">Teclado</font> con el siguiente comando `xset led on`.
...
<br>
<p><center><font color="yellow">[<font color="red">*</font>]</font><font color="green"> Scaneo de dispositivos en red</font></center></p>
<br>
