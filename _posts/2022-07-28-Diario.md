...
<p><font color="yellow">[<font color="red">*</font>]</font> <font color="lime">Creacion de tareas para ejecutarce en un determinado tiempo</font></p>
<p> Para ejecutar una tarea en un determinado tiempo se usa la herramienta crom</p>
* Si estas en arch puedes que no la tengas instalada para eso :
```1
paru -S crom
```
* Si no tienes paru en tu arhc-linux :
```1
git clone https://aur.archlinux.org/paru.git && cd paru && makepkg -si && yay -S paru
```
<br>

<p><font color="yellow">[<font color="red">*</font>]</font> Esta herramienta te permite ejecutar herramientas en un determinado tiempo.</p>

* crear nueva tarea :
<p> Para ello te tienes que ir a la <font color="blue">ruta</font> : </p>
```1
/etc/cron.d/
```
<p><font color="yellow">*</font> Posteriormente creamos el archivo que se va a ejecutar, y de contenido le colocamos esto : </p>
```1
...
*  <p><font color="yellow"> *  *  *  *  *</font> -> Siginfica que la tarea se ejecutara cada minuto.</p>
...
-----
<p><font color="yellow">[<font color="red">*</font>]</font> Para ver las tareas que se estan ejecutando a tiempo real se usa el <font color="blue">comando</font> : </p>
```1
ps -eo command
```
